...
/**
 * A speed-improved simplex noise algorithm for 1D, 2D, 3D and 4D in Java.
 * <p>
 ...
 *
 */
public final class SimplexNoise {  // Simplex noise in 1D, 2D, 3D and 4D

    private static final Grad[] grad2 = {new Grad(1, 0), new Grad(-1, 0), new Grad(0, 1), new Grad(0, -1)};
    ...
    public static float fbm(float x, int octaves, float persistence, float lacunarity) {
        ...
        for (int i = 1; i < octaves; i++) {
            ...
            // Keep the same behaviour as the processing perlin noise() function, return values in the [0,1] float
            // range.
    ...
    public static float fbm(float x, float y, float z, float t, int octaves, float persistence, float lacunarity) {
        ...
        for (int i = 1; i < octaves; i++) {
            ...
            // Keep the same behaviour as the processing perlin noise() function, return values in the [0,1] float
            // range.
            r += (((float) noise((double) (frequency * x), (double) (frequency * y), (double) (frequency * z),
                    (double) (frequency * t)) + 1) / 2.0f) * amp;
        }
        return r / maxamp;
    }
