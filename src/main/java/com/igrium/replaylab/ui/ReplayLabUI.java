...
public class ReplayLabUI extends DockSpaceApp {
    ...
    private void drawPlaybackControls() {
        ...
        if(playbackIcon(ReplayLabIcons.ICON_TO_START_ALT, t("gui.replaylab.sceneStart"), buttonSize)) {
            editorState.setPlayhead(editorState.getScene().getStartTime());
            editorState.queueTimeJump();
        }

        playbackIcon(ReplayLabIcons.ICON_TO_START, t("gui.replaylab.prevKey"), buttonSize);
        ...
        playbackIcon(ReplayLabIcons.ICON_TO_END, t("gui.replaylab.nextKey"), buttonSize);

        if (playbackIcon(ReplayLabIcons.ICON_TO_END_ALT, t("gui.replaylab.sceneEnd"), buttonSize)) {
            editorState.setPlayhead(editorState.getScene().getEndTime());
            editorState.queueTimeJump();
        }
        ...
        if (ReplayLabControls.toggleButton(ReplayLabIcons.ICON_FREE_TRANSFORM, t("key.replaylab.gizmo_all"), tmpBoolean)) {
        ...
        if (ReplayLabControls.toggleButton(ReplayLabIcons.ICON_SCALE, t("key.replaylab.gizmo_scale"), tmpBoolean)) {
            editorState.showGizmoScale(tmpBoolean.get());
            if (!ImGui.getIO().getKeyCtrl()) {
                editorState.showGizmoPos(false);
                editorState.showGizmoRot(false);
        ...
        if (ReplayLabControls.toggleButton(localIcon, "key.replaylab.local_transforms", tmpBoolean)) {
